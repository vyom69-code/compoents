...
export default function SignUpForm() {
  ...
  return (
    <div className="w-full min-h-screen bg-background relative overflow-hidden px-4 lg:px-8 py-12 flex flex-col justify-between">
  ...
  <div className="space-y-6">
    <div className="space-y-2">
      <label
        className="block text-gray-300 text-base font-thin"
      ...
      <input
        ...
        className="w-full h-10 bg-secondary border-none rounded-lg px-4 py-2 text-gray-300 placeholder-gray-500 focus:ring-2 focus:ring-primary opacity-90"
    ...
    <div className="space-y-2">
      ...
      />
          ...
          <button
            type="submit"
            className="w-full h-[48px] bg-gradient-to-r from-blue-400 to-blue-600 text-white rounded-lg hover:opacity-90 transition-opacity font-light"
            onClick={(e) => {
              e.preventDefault()
              router.push("/signin")
            }}>
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center">
              <span className="px-2 bg-background text-gray-500 text-xs">OR</span>
            </div>
          </div>
          ...
          <div className="space-y-3">
            <button
              type="button"
              className=" font-thin w-full h-[44px] flex items-center justify-start gap-2 bg-[rgba(38,39,44,1)] hover:bg-opacity-90 text-gray-300 rounded-lg transition-colors pl-4 text-[14px]"
            >
            ...
            <button
              type="button"
              className="w-full h-[44px] flex items-center justify-start gap-2 bg-secondary hover:bg-opacity-90 text-gray-300 rounded-lg transition-colors font-thin pl-4 text-[14px]"
            >
